...
| SEC-14 | Medium                | A real two-data-plane isolation test cannot run until EB-02 is resolved. The current control plane has 0 tenants/deployments/domains.                                                                                                                                                                                                                              | Open — EB-02                                                  |
